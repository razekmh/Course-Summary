...
class _AggregationCommand(object):
    ...
    def _process_result(self, result, session, server, sock_info, subordinate_ok):
        if self._result_processor:
            self._result_processor(
                result, session, server, sock_info, subordinate_ok)
    ...
    def get_cursor(self, session, server, sock_info, subordinate_ok):
        ...
        self._process_result(result, session, server, sock_info, subordinate_ok)
